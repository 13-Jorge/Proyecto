...
$pdo = connectDB();
if ($pdo != null) {
    $consulta = "INSERT INTO propiedades (titulo, descripcion, precio, direccion, ciudad, codigo_postal, pais, tipo, superficie, num_habitaciones, num_banos) VALUES (:titulo, :descripcion, :precio, :direccion, :ciudad, :codigo_postal, :pais, :tipo, :superficie, :num_habitaciones, :num_banos)";
